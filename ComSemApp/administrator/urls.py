...
urlpatterns = [
    ...
    url(r'^discussion_board$', discussion_views.TopicListView.as_view(), name='discussion_board'),
    url(r'^topic/(?P<topic_id>[0-9]+)/$', discussion_views.ReplyView.as_view(), name='topic'),
    url(r'^newtopic/$', discussion_views.CreateThreadView.as_view(),name='create_topic')
]
